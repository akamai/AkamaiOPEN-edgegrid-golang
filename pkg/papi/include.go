...
func (p *papi) ListIncludes(ctx context.Context, params ListIncludesRequest) (*ListIncludesResponse, error) {
	...
	req, err := request.NewGet(ctx, "/papi/v1/includes").
...
func (p *papi) ListIncludeParents(ctx context.Context, params ListIncludeParentsRequest) (*ListIncludeParentsResponse, error) {
	...
	req, err := request.NewGet(ctx, "/papi/v1/includes/%s/parents", params.IncludeID).
...
func (p *papi) GetInclude(ctx context.Context, params GetIncludeRequest) (*GetIncludeResponse, error) {
	...
	req, err := request.NewGet(ctx, "/papi/v1/includes/%s", params.IncludeID).
		AddQueryParam("contractId", params.ContractID).
...
func (p *papi) CreateInclude(ctx context.Context, params CreateIncludeRequest) (*CreateIncludeResponse, error) {
	...
	req, err := request.NewPost(ctx, "/papi/v1/includes").
		AddQueryParam("contractId", params.ContractID).
		AddQueryParam("groupId", params.GroupID).
		WithBody(params).
		Build()
...
func (p *papi) DeleteInclude(ctx context.Context, params DeleteIncludeRequest) (*DeleteIncludeResponse, error) {
	...
	req, err := request.NewDelete(ctx, "/papi/v1/includes/%s", params.IncludeID).
		AddQueryParamIf("contractId", params.ContractID, params.ContractID != "").
		AddQueryParamIf("groupId", params.GroupID, params.GroupID != "").
		Build()
	if err != nil {
