			...
			responseBody: `
{
    ...
    "version": 6
		...
		"validation error, simple AP missing passThroughPercent": {
			request: CreatePolicyVersionRequest{
				CreatePolicyVersion: CreatePolicyVersion{
					MatchRules: MatchRules{
						&MatchRuleAP{
    ...
    "version": 6
		...
		"validation error, simple VWR missing configuration": {
			request: CreatePolicyVersionRequest{
				CreatePolicyVersion: CreatePolicyVersion{
					MatchRules: MatchRules{
						&MatchRuleVWR{
		...
		"validation error, simple VWR missing configuration option": {
			request: CreatePolicyVersionRequest{
				CreatePolicyVersion: CreatePolicyVersion{
					Configuration: &Configuration{},
					MatchRules: MatchRules{
