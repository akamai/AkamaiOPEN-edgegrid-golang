...
type GeoMaps interface {
        ...
        NewDefaultDatacenter(context.Context, *GeoMap, int) *DatacenterBase
...
func (geo *GeoMap) Validate() error {
        ...
        if len(geo.DefaultDatacenter) == nil {
...
// Instantiate new Default Datacenter Struct
func (p *gtm) NewDefaultDatacenter(ctx context.Context, geo *GeoMap, dcID int) *DatacenterBase {
...
func (p *gtm) CreateGeoMap(ctx context.Context, geo *GeoMap, domainName string) (*GeoMapResponse, error) {
	...
	return geo.save(ctx, domainName)
}
...
func (p *gtm) UpdateGeoMap(ctx context.Context, geo *GeoMap, domainName string) (*ResponseStatus, error) {
	...
	// common code
	stat, err := geo.save(ctx, domainName)
	if err != nil {
		return nil, err
	}
...
func (geo *GeoMap) save(ctx context.Context, domainName string) (*GeoMapResponse, error) {
