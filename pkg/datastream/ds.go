...
type (
	...
	DS interface {
		...
		//
		// See: https://techdocs.akamai.com/datastream2/reference/post-stream-activate
		...
		//
		// See: https://techdocs.akamai.com/datastream2/reference/post-stream-deactivate
		...
		//
		// See: https://techdocs.akamai.com/datastream2/reference/get-properties-cdn
		...
		//
		// See: https://techdocs.akamai.com/datastream2/reference/get-dataset-fields
		...
		// ListAnswerXServiceIDs returns the AnswerX service IDs available for streaming for a given contract.
		//
		// See: https://techdocs.akamai.com/datastream2/reference/get-answerx-ssids
		ListAnswerXServiceIDs(context.Context, ListAnswerXServiceIDsRequest) (*ListAnswerXServiceIDsResponse, error)

		// Stream

		// CreateStream creates a stream
		//
		// See: https://techdocs.akamai.com/datastream2/reference/post-stream-cdn
		// See: https://techdocs.akamai.com/datastream2/reference/post-stream-appsec
		// See: https://techdocs.akamai.com/datastream2/reference/post-stream-answerx
		...
		//
		// See: https://techdocs.akamai.com/datastream2/reference/put-stream-cdn
		// See: https://techdocs.akamai.com/datastream2/reference/put-stream-appsec
		// See: https://techdocs.akamai.com/datastream2/reference/put-stream-answerx
