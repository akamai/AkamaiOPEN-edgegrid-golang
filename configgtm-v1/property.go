...
func ListProperties(domainname string) ([]*Property, error) {
        ...
        req, err := client.NewRequest(
                Config,
                "GET",
                "/config-gtm/v1/domains/"+domainname+"/properties",
                nil,
        )
        if err != nil {
                return nil, err
...
func GetProperty(propertyname, domainname string) (*Property, error) {
	...
	req, err := client.NewRequest(
		Config,
		"GET",
		"/config-gtm/v1/domains/"+domainname+"/properties/"+propertyname,
		nil,
	)
	if err != nil {
		return nil, err
	...
	if client.IsError(res) && res.StatusCode != 404 {
		...
		return nil, &CommonError{entityName: "Property", name: propertyname}
	} else {
...
func (property *Property) save(domainname string)  (*PropertyResponse,error) {
	...
	req, err := client.NewJSONRequest(
		Config,
		"PUT",
		"/config-gtm/v1/domains/"+domainname+"/properties/"+property.Name,
		property,
	)
	if err != nil {
		return nil, err
